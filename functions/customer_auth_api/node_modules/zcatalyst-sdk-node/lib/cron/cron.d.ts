...
type ICatalystCronReq = Omit<ICatalystCron, 'id' | 'success_count' | 'failure_count'>;
type ICatalystCronRes = ICatalystCron & ICatalystGResponse;
type ICatalystCronUpdateReq = Partial<Omit<ICatalystCron, 'success_count' | 'failure_count'>> & {
    status: boolean;
};
