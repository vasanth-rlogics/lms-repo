...
class QuickML {
    ...
    predict(endPointKey, inputData) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, validator_1.wrapValidatorsWithPromise)(() => {
                (0, validator_1.isNonEmptyObject)(inputData, 'input data', true);
                (0, validator_1.isNonEmptyString)(endPointKey, 'endpoint key', true);
            }, error_1.CatalystQuickMLError);
            const request = {
                method: REQ_METHOD.post,
                path: `/${PRODUCT_NAME.quickml}/${API_VERSION}/project/${this.projectId}/endpoints/predict`,
                data: { data: inputData },
