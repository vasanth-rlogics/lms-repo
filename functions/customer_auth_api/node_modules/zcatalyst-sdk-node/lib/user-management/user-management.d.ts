...
type ICatalystNewUser = ICatalystSignupConfig & {
...
export declare class UserManagement implements Component {
     ...
     * @returns Catalyst user details
     */
    registerUser(signupConfig: ICatalystSignupConfig, userDetails: Omit<ICatalystSignupUserConfig, 'org_id'>): Promise<ICatalystNewUser>;
    /**
     ...
     * @returns
     */
    resetPassword(email: string, resetConfig: ICatalystSignupConfig): Promise<string>;
     ...
     */
    updateUserDetails(id: string, userDetails: ICatalystSignupUserConfig): Promise<ICatalystUser>;
}
export {};
