...
class UserManagement {
     ...
     * @returns
     */
    resetPassword(email, resetConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, validator_1.wrapValidatorsWithPromise)(() => {
                (0, validator_1.isNonEmptyObject)(resetConfig, 'resetConfig', true);
                (0, validator_1.ObjectHasProperties)(resetConfig, ['platform_type'], 'resetConfig', true);
                (0, validator_1.isNonEmptyString)(email, 'email_id', true);
            }, error_1.CatalystUserManagementError);
