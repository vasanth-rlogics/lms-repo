...
class BulkWrite extends BulkJob {
    ...
    createJob(fileDetails, options, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = Object.assign({ table_identifier: this.identifier, callback }, options);
            let fileData = {};
            if ((0, validator_1.isNonEmptyString)(fileDetails)) {
                fileData = { file_id: fileDetails };
            }
            else {
                yield (0, validator_1.wrapValidatorsWithPromise)(() => {
                    (0, validator_1.isNonEmptyObject)(fileDetails, 'object_details', true);
                }, error_1.CatalystDatastoreError);
