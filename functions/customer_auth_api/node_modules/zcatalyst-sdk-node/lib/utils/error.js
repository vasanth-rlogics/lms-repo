...
class CatalystConnectionsError extends PrefixedCatalystError {
    constructor(code, message, value) {
        super('connections', code, message, value);
    }
}
exports.CatalystConnectionsError = CatalystConnectionsError;
