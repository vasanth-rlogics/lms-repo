...
const { PROJECT_KEY_NAME, ZAID, IS_LOCAL, ENVIRONMENT_KEY_NAME, ENVIRONMENT, USER_KEY_NAME, CREDENTIAL_USER, CATALYST_ORIGIN, X_ZOHO_CATALYST_ORG_ID, PRODUCT_NAME, API_VERSION, USER_AGENT, APM_INSIGHT, ACCEPT_HEADER, REQ_RETRY_THRESHOLD, PROJECT_HEADER } = constants_1.default;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            const retryRequest = (err) => __awaiter(this, void 0, void 0, function* () {
                logger_1.LOGGER.warn('>>> RETRYING REQUEST ');
                ...
                try {
                    options.agent = new request_agent_1.default((0, helper_1.isHttps)(config.url), options.hostname, true)._agent;
            ...
            const req = transport.request(options, (res) => __awaiter(this, void 0, void 0, function* () {
                ...
                logger_1.LOGGER.debug(`>>> HTTP REQUEST : ${(_a = req.method) === null || _a === void 0 ? void 0 : _a.toUpperCase()} ${req.protocol}//${req.host}${req.path}`);
                ((_b = process.env.ZC_SECURE) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === 'override' &&
                    logger_1.LOGGER.fine(`>>> REQUEST HEADERS : ${JSON.stringify(options.headers)}`);
                logger_1.LOGGER.debug(`<<< HTTP RESPONSE : ${res.statusCode} : ${Date.now() - startTimeStamp} ms`);
                ((_c = process.env.ZC_SECURE) === null || _c === void 0 ? void 0 : _c.toLowerCase()) === 'override' &&
                    logger_1.LOGGER.fine(`<<< RESPONSE HEADERS : ${JSON.stringify(res.headers)}`);
            ...
            req.on('error', (err) => {
                ...
                ((_b = process.env.ZC_SECURE) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === 'override' &&
                    logger_1.LOGGER.fine(`>>> REQUEST HEADERS : ${JSON.stringify(options.headers)}`);
                logger_1.LOGGER.debug(`<<< HTTP REQUEST ERROR : ${(0, util_1.inspect)(err)} : ${Date.now() - startTimeStamp} ms`);
                if (req.aborted || config.type === "raw" /* RequestType.RAW */) {
                    return reject(err);
                }
                retryRequest(err);
            });
            ...
            if (config.type !== "file" /* RequestType.FILE */ && config.type !== "raw" /* RequestType.RAW */) {
                req.write(data);
                req.end();
                return;
            }
    ...
    send(req, apmTrackerName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.app !== undefined) {
                ...
                const userType = this.app.credential.getCurrentUserType();
                // now it's only for stratus
                if (req.external && this.user !== 'admin' && userType !== 'admin') {
                    req.qs[ZAID] = this.app.config.projectKey;
                }
                if (!req.external) {
                    ...
                    if ((0, validator_1.isNonEmptyString)(process.env.X_ZOHO_CATALYST_ORG_ID)) {
                        req.headers[X_ZOHO_CATALYST_ORG_ID] = process.env
