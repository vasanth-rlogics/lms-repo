...
export declare class JwtTokenCredential extends Credential {
    projectId: string;
    projectKey: string;
    projectDomain: string;
    jwtRes: JwtResponse | null;
    cookie: string;
    cachedToken: {
        access_token: string;
        expires_in: number;
    ...
    convertJwtToToken(jwtRes: JwtResponse): Promise<{
        access_token: string;
        expires_in: number;
    }>;
    generateJwtToken(cookie: string): Promise<void>;
    getToken(): Promise<{
        access_token: string;
    }>;
}
