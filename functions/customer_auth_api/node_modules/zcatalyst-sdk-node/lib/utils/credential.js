...
exports.ApplicationDefaultCredential = exports.CatalystCredential = exports.JwtTokenCredential = exports.CookieCredential = exports.TicketCredential = exports.AccessTokenCredential = exports.RefreshTokenCredential = exports.Credential = exports.globalValue = void 0;
...
const AUTH_PORTAL = process.env.CATALYST_PORTAL_DOMAIN;
...
class JwtTokenCredential extends Credential {
    constructor(config) {
        super();
        this.projectDomain = getAttr(config, 'projectDomain', 'project_domain');
        this.projectId = getAttr(config, 'projectId', 'project_id');
        this.projectKey = getAttr(config, 'projectKey', 'project_key');
        this.cookie = getAttr(config, 'cookie', 'cookie');
        this.cachedToken = null;
        this.jwtRes = null;
    }
    convertJwtToToken(jwtRes) {
        return __awaiter(this, void 0, void 0, function* () {
            const option = {
                method: REQ_METHOD.post,
                headers: {
                    Origin: 'https://' + this.projectDomain
                },
                qs: {
                ...
                origin: AUTH_PORTAL,
                auth: false,
                path: `/clientoauth/v2/${this.projectKey}/remote/auth`,
                catalyst: false
            };
            return yield requestAccessToken(option);
        });
    }
    generateJwtToken(cookie) {
        return __awaiter(this, void 0, void 0, function* () {
            const option = {
                ...
                path: `/baas/v1/project/${this.projectId}/authentication/custom-token`,
                catalyst: false,
                auth: false,
                user: CREDENTIAL_USER.user
            };
            this.jwtRes = (yield new api_request_1.HttpClient().send(option)).data.data;
        });
    }
    getToken() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (((_a = this.cachedToken) === null || _a === void 0 ? void 0 : _a.access_token) && this.cachedToken.expires_in > Date.now()) {
                return this.cachedToken;
            }
            if (this.jwtRes === null) {
                yield this.generateJwtToken(this.cookie);
            }
            const token = yield this.convertJwtToToken(this.jwtRes);
            this.cachedToken = token;
            this.cachedToken.expires_in = Date.now() + token.expires_in - 300000;
            return this.cachedToken;
        });
    }
}
exports.JwtTokenCredential = JwtTokenCredential;
